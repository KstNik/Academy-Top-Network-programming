...
Задание 4. Добавьте ко второму заданию отображение обложек книг из списка 100 самых популярных книг.

Задание 5. Создайте приложение, которое позволяет скачать все книги указанного автора из библиотеки Гуттенберга. Перед скачиванием пользователь указывает фамилию и имя автора.
